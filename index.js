...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        // Set inner HTML of the game card
        gameCard.innerHTML = `
...
A total of $${totalRaised.toLocaleString()} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfunded} game${numUnfunded !== 1 ? "s are" : " is"} unfunded. We need your help to fund these amazing games!
`;
